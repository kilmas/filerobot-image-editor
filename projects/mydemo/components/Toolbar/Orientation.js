        ...
        <RotateWrapper>
          <RotateButton>
            ...
            {!processWithCloudService && (
              <>
                <DarkBtn onClick={() => { this.onFlip('x'); }}><RotateIcon name="flip-h"/></DarkBtn>
                <DarkBtn onClick={() => { this.onFlip('y'); }}><RotateIcon name="flip-v"/></DarkBtn>
              </>
            )}
            ...
            <div>
              ...
              <svg viewBox="-91 -5 180 10" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
